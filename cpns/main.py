...
base_url = 'https://api-sscasn.bkn.go.id/2024/portal/spf?kode_ref_pend=5101087&offset='
...
df.to_csv('data-formasi-s1-teknik-informatika.csv', index=False)

print("Data has been successfully saved to 'data-formasi-s1-teknik-informatika.csv")